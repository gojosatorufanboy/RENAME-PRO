...
async def start(client, message):
    ...
    await message.reply_photo(photo=BOT_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                        [[InlineKeyboardButton("📢 Updates", url="https://t.me/devilcartoonsoffical"),
                                        InlineKeyboardButton("💬 Support", url="https://t.me/devilcartoonsoffical")],
                                        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
				                        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                                        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/SatoruGojo830")]
                                        ]))
    return
